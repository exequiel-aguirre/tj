...
\begin{center}
$s_X={v \cdot S_X\over{v \cdot \overline1}} = {D(p,q,S_X)\over{D(p,q,\overline1)}}$ , 
$s_Y={v \cdot S_Y\over{v \cdot \overline1}} = {D(p,q,S_Y)\over{D(p,q,\overline1)}}$
\end{center}
...
\begin{center}
 $\alpha s_X + \beta s_Y + \gamma={D(p,q,\alpha S_X + \beta S_Y + \gamma\cdot \overline1)\over{D(p,q,\overline1)}}$
\end{center}
